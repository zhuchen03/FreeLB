...
exp_name=yopo-syncdp-${DATA}-iters${TOTAL_NUM_UPDATES}-warmup${WARMUP_UPDATES}-lr${LR}-bsize${MAX_SENTENCES}-freq${FREQ}-advlr${ADV_LR}-advstep${ADV_STEPS}-initmag${INIT_MAG}-fp32-seed${SEED}-beta0.999-newinit-morm${MNORM}-yopos${YOPOS}
...
run_exp      0        2036                 122         1e-5       2           2            8     RTE           3e-2      3      1.6e-1   1234    1.4e-1     3
