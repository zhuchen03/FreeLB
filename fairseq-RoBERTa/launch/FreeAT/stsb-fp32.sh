...
exp_name=FreeAT-syncdp-${DATA}-iters${TOTAL_NUM_UPDATES}-warmup${WARMUP_UPDATES}-lr${LR}-bsize${MAX_SENTENCES}-freq${FREQ}-advlr${ADV_LR}-advstep${ADV_STEPS}-initmag${INIT_MAG}-fp32-seed${SEED}-mnorm${MNORM}-beta0.999
...
#run_exp      4        3598                  214         2e-05       1           8            2      STS-B     1e-1       3      1.6e-1   1234     2.8e-1
#run_exp      4        3598                  214         2e-05       1           8            2      STS-B     1e-1       3      1.6e-1   7456     2.8e-1
